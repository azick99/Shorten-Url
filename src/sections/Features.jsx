...
const Features = () => {
  ...
  return (
    <section id="features" className=" bg-gray/20 w-full h-full sm:mt-[8rem] mt-[5rem] scroll-mt-40">
        ...
        <div className="sm:p-10 p-4 shorten flex sm:flex-row flex-col">
          <div className="sm:w-4/5 w-full">
            <input
              ...
              className={`border-2 ${status === 'empty' || error !== null
        ...
        <div>
          {urls.map((url) => {
            ...
            return (
              ...
              >
                <p className="basis-4/6 overflow-x-auto sm:border-0 border-b sm:mb-0 sm:p-0 p-4 w-full"> {original_link}</p>
                <div className="basis-2/6 flex sm:flex-row flex-col sm:gap-y-0 gap-y-3 gap-x-2 items-center sm:p-0 p-4 w-full">
                  ...
                  <button
                    ...
                    className={`${copied ? 'dark-btn' : 'sm-rounded-btn'} w-full`}
                  >
                    {copied ? 'Copied!' : 'Copy'}
                  </button>
                  <button
