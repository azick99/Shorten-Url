...
const Technology = () => {
  return (
    <section
      id="pricing"
      className="bg-gray/20 pb-40 scroll-mt-20  widescreen:section-min-height tallscreen:section-min-height"
    >
      <div className="w-[85vw] mx-auto ">
        <div className="sm:w-[42%] w-[60%] text-center mx-auto mb-20">
          ...
          <p className="text-grayish-violet mt-3 ">
        ...
        <div className="relative flex sm:flex-row flex-col gap-x-8 gap-y-12 items-center justify-center">
          ...
          {techs.map((tech) => {
            ...
            return (
              <article
                key={title}
                className={`bg-white  w-80 px-6 rounded-md ${transform}`}
              >
                <div className="space-y-3 -translate-y-9 flex flex-col sm:items-start items-center">
                  ...
                  <p className="text-grayish-violet sm:text-left text-center">
                    {description}
                  </p>
                </div>
              </article>
